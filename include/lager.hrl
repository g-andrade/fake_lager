...
%% Copyright (C) 2019-2022 Guilherme Andrade (modifications)
%%
...
-define(LEVELS_UNSAFE,
        [{debug_unsafe, debug}, {info_unsafe, info}, {notice_unsafe, notice}, {warning_unsafe, warning}, 
...
%         band element(1, lager_config:get({Sink, loglevel}, {?LOG_NONE, []}))) 
%        /= 0).
%
%-define(SHOULD_LOG(Level),
%        (lager_util:level_to_num(Level) 
%         band element(1, lager_config:get(loglevel, {?LOG_NONE, []}))) 
%        /= 0).
%
